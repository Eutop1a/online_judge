...
func (wrapper *submitWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
// NewSubmitWrapper 初始化Wrapper
func NewSubmitWrapper(c client.Client) client.Client {
	return &submitWrapper{c}
}
